      ...
      <Card className="mt-4">
        ...
        <Card.Body>
          <Row>
            <Col md={6}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item><strong>Health Conditions:</strong> {member.healthConditions}</ListGroup.Item>
              </ListGroup>
            </Col>
            <Col md={6}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item><strong>Workout Plan:</strong> {member.workoutPlan}</ListGroup.Item>
              </ListGroup>
            </Col>
          </Row>
          ...
          <div className="mt-4 d-flex justify-content-end">
            <Button variant="secondary" onClick={() => navigate('/members')}>Back to Members</Button>
          </div>
        </Card.Body>
      </Card>
    </div>
